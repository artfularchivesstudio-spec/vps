...
-- This migration ensures ALL RLS policies use the optimized format
-- and addresses any remaining linter warnings

-- Force drop ALL existing policies and recreate them with guaranteed optimization
